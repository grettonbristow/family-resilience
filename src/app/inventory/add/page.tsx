  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-6 pb-24">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Add Supply</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-gray-900 bg-white placeholder:text-gray-400"
          />
        </div>
        ...
        <div>
          <label htmlFor="min-qty" className="block text-sm font-medium text-gray-700 mb-1.5">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Brand, purchase date, etc."
            rows={2}
